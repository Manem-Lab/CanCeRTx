      ...
      tags$div(
        ...
        tags$style(HTML(
          ".home, .home:focus, .home:hover {
            background-color: rgba(181, 198, 245, 0.8);
            color: white;
            border: 0px;
            border-radius: 10px;
            padding-top: 20px;
      ...
      tags$div(class = "carousel-container",
          tags$div(class = "carousel-wrapper",
              tags$div(id = "carousel", class = "carousel",
                  ...
                  tags$div(class = "carousel-item",
                      tags$div(class = "card",
                               style = "display: flex; flex-direction: column; justify-content: left; align-items: unset;",
      ...
      tags$div(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            verticalLayout(
              tags$div(
                style = "padding: 25px; width: 100%; display: flex; flex-direction: row; gap: 50px;",
                tags$div(
                  style = "width: 20vw",
